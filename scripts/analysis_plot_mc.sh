...
ls $OUTPUT_DIR/Run3/nominal_4j2b/flavor_sum/region_sum/HHbbWW/Hbb_mass.pdf
ls $OUTPUT_DIR/Run3/nominal_4j2b/flavor_sum/region_CR/HHbbWW/Hbb_mass.pdf
ls $OUTPUT_DIR/Run3/nominal_4j2b/flavor_sum/region_SR/HHbbWW/Hbb_mass.pdf


display_section_header "check making the plots from yaml "
run_command python src/plotting/plot_from_yaml.py --input_yaml \
        $OUTPUT_DIR/Run3/nominal_4j2b/flavor_sum/region_sum/HHbbWW/Hbb_mass.yaml \
        $OUTPUT_DIR/Run3/nominal_4j2b/flavor_sum/region_CR/HHbbWW/Hbb_mass.yaml \
        $OUTPUT_DIR/Run3/nominal_4j2b/flavor_sum/region_SR/HHbbWW/Hbb_mass.yaml \
        --out $OUTPUT_DIR/test_plots_from_yaml 
    
display_section_header "Checking if pdf files exist"
ls $OUTPUT_DIR/test_plots_from_yaml/Run3/nominal_4j2b/flavor_sum/region_sum/HHbbWW/Hbb_mass.pdf
ls $OUTPUT_DIR/test_plots_from_yaml/Run3/nominal_4j2b/flavor_sum/region_CR/HHbbWW/Hbb_mass.pdf
ls $OUTPUT_DIR/test_plots_from_yaml/Run3/nominal_4j2b/flavor_sum/region_SR/HHbbWW/Hbb_mass.pdf
