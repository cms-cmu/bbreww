...
def dump_phh_to_pickle(selected_events, dataset, output_path):
    ...
    phh_data = {
        ...
        'incl_3j2b': {
            'phh': ak.to_numpy(selected_events.SvB.phh[selected_events.incl_3j2b & selected_events.region.SR]),
            'weight': ak.to_numpy(selected_events.weight[selected_events.incl_3j2b & selected_events.region.SR]),
        },
    }
