...
class SvBHists(Template):
    ...
    phh_variable_nominal = H(([0.000000, 0.244000, 0.596000, 0.768000, 0.900000, 0.928000, 0.968000, 0.984000, 1.000000],
            ('phh', "Regressed P(Signal) bin #")))
    
    phh_variable_lowpt = H(([0.000000, 0.268000, 0.456000, 0.680000, 0.812000, 0.868000, 0.944000, 0.960000, 1.000000],
            ('phh', "Regressed P(Signal) bin #")))

    phh_variable_3j2b = H(([0.000000, 0.372000, 0.612000, 0.736000, 0.848000, 0.888000, 0.904000, 0.920000, 0.944000, 1.000000],
                           ('phh', "Regressed P(Signal) bin #")))
